...
all_df = pd.read_csv("https://raw.githubusercontent.com/hendykarles/data_analisis/main/dashboard/all_data.csv")
all_df.sort_values(by="order_approved_at", inplace=True)
all_df.reset_index(inplace=True)

# Geolocation Dataset
geolocation = pd.read_csv('https://raw.githubusercontent.com/hendykarles/data_analisis/main/dashboard/all_data.csv')
...
st.caption('Copyright (C) Hendy Karles 2023')
